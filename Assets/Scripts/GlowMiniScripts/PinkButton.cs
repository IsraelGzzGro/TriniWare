...
public class PinkButton : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        {
            buttoncontroller.pinkb.sprite = buttoncontroller.pinkdown;
        }
    }
    private void OnMouseUp()
    {
        if (buttoncontroller.waitfororders == false)
        {
            buttoncontroller.pinkb.sprite = buttoncontroller.pinkup;
            ...
            else
            {
                if (buttoncontroller.mousecounter == buttoncontroller.totalnum - 1)
                {
                    if (buttoncontroller.orderarr[buttoncontroller.mousecounter] != 1)
                    {
                        buttoncontroller.failedpattern = true;
                        buttoncontroller.won = false;
                        buttoncontroller.endtimer = 1;
